...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene)
{
	...
	if (mesh->mMaterialIndex >= 0)
	{
		...
		vector<Texture> displacementMaps = loadMaterialTextures(material, aiTextureType_DISPLACEMENT, "texture_normal");
		vector<Texture> normalMaps = loadMaterialTextures(material, aiTextureType_HEIGHT, "texture_displacement");
		vector<Texture> somethingMap = loadMaterialTextures(material, aiTextureType_NORMALS, "texture_emissive");
		...
		textures.insert(textures.end(), somethingMap.begin(), somethingMap.end());
	}
